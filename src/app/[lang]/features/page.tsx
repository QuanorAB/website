...
export async function generateMetadata({ params }: { params: Promise<{ lang: string }> }): Promise<Metadata> {
    ...
    return {
        ...
        description: lang === 'sv'
            ? 'Upptäck Quanors kraftfulla AI-verktyg för finansiell analys. Realtidsdata, automatisk rapportanalys, pressmeddelande-bevakning och mer.'
            : 'Discover Quanor\'s powerful AI tools for financial analysis. Real-time data, automated report analysis, press release monitoring and more.',
    };
}
...
const content = {
    sv: {
        hero: {
            title: "Kraftfulla verktyg för smartare investeringar",
        ...
        features: [
            {
                ...
                capabilities: [
                    ...
                    "Kontinuerlig fördjupning under timmar efterfåt",
            ...
            },
            {
                ...
                capabilities: [
                    ...
                    "Historisk träffsäkerhet för guidance",
    ...
    en: {
        hero: {
            title: "Powerful tools for smarter investments",
        ...
        features: [
            {
                ...
                capabilities: [
                    ...
                    "Continuous deepening over hours",
