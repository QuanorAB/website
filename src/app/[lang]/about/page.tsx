...
export async function generateMetadata({ params }: { params: Promise<{ lang: string }> }): Promise<Metadata> {
    ...
    return {
        title: lang === 'sv'
            ? 'Om Oss - Svenskt AI-team för Aktieanalys | Quanor'
            : 'About Us - Swedish AI Team for Stock Analysis | Quanor',
        description: lang === 'sv'
    ...
    advisors: [
        {
            ...
            bio: {
                sv: "Expert inom LLM och AI.",
                en: "LLM and AI expert."
            }
        },
        {
            ...
            bio: {
                sv: "Expert inom finansiell matematik.",
                en: "Expert in financial mathematics."
            }
        },
        {
            name: "Oskar Mühlbach",
            role: { sv: "Rådgivare", en: "Advisor" },
            image: "/team/oskar-mühlbach.jpg",
            bio: {
                sv: "Expert inom strategi.",
                en: "Strategy expert."
            }
        }
    ]
