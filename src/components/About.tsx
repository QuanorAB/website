...
export default function About({ lang }: { lang: string }) {
    const content = {
        sv: {
            ...
            description1: "Quanor grundades med visionen att demokratisera tillgången till avancerad finansiell analys. Genom att kombinera expertis inom finans med spjutspetsteknologi inom AI, skapar vi verktyg som ger investerare ett övertag.",
            description2: "Vår plattform analyserar miljontals datapunkter varje dag för att leverera analyser som tidigare krävde hela analysteam.",
        ...
        en: {
            ...
            description1: "Quanor was founded with the vision to democratize access to advanced financial analysis. By combining financial expertise with cutting-edge AI technology, we create tools that give investors an edge.",
            description2: "Our platform analyzes millions of data points every day to deliver analysis that previously required entire analyst teams.",
