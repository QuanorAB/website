...
export default function Teaser({ lang }: { lang: string }) {
    const content = {
        sv: {
            ...
            description: "Vi har ett proprietärt relationsuniversum och bolagsspecifika triggers som vi använder i våra analyser. Se hur varje bolag är kopplat till sina konkurrenter, kunder och leverantörer, och få automatiska varningar för viktiga händelser.",
            features: [
        ...
        en: {
            ...
            description: "We have a proprietary relationship universe and company-specific triggers that we use in our analysis. See how each company is connected to its competitors, customers, and suppliers, and get automatic alerts for important events.",
            features: [
